...
function WebTrends(){
		 ...
		 this.downloadtypes="xls,xlsx,doc,docx,pdf,txt,csv,zip,ppt,pptx,avi,wmv,mov,rm,mp2,mp3,mp4,flv,swf,tar,rar,gz,mpeg,mpg,wav,wma,ai,cdr,wpd,eps,tif,tiff,epub,webm,xsd,xml,sps";
		 this.navigationtag="div,table";
		 this.metanames="dcterms.language,dcterms.type,dcterms.subject,dcterms.issued,dcterms.modified,author,dcterms.created,dcterms.publisher,dcterms.format,site_product_code,dcterms.identifier,dc.subject,dc.date.created,dc.date.modified,dc.date.issued,review_date,dc.language,dc.publisher,dc.type,dc.format,wt-breadcrumb";
